...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.textChanged.connect(self.btn_disabled)
        self.btnCount.clicked.connect(self.clear_before_count)
    ...
    #todo mozna edytowac lineedit bo reszta zostaje w pamieci
    #todo loop checkboxy i pusty lineedit

    def verify_empty_widets(self):
